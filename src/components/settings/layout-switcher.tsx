...
import HydrogenIcon from "../icons/hydrogen-icon";
import HeliumIcon from "../icons/helium-icon";
import LithiumIcon from "../icons/lithium-icon";
import BerylliumIcon from "../icons/beryllium-icon";
