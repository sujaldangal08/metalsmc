...
export default function SearchTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="search-command ms-auto hidden items-center text-sm text-gray-600 lg:flex lg:rounded-md bg-green lg:px-1.5 lg:py-1 lg:text-xs lg:font-semibold lg:text-primary-foreground xl:justify-normal">
        {os === "macos" ? (
